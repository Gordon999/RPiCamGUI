...
Script to allow control of a Pi Camera. Will work with all Pi camera models, v1, v2, v3, HQ, GS and imx500. Also Arducam 16MP or 64MP Autofocus cameras, Waveshare imx290-83 or imx415-98 cameras, imx585 and ov9281. It should also recognise other cameras if you have a dtoverlay for it, and added in the /boot/firmware/config.txt, but it may not be optimal.
...
imx415
add dtoverlay=imx415,4lane,clk-37125 to config.txt , add cam0 or cam1 if using a Pi5.
...
## Innomaker ov9281
add dtoverlay=ov9281 to config.txt.
