...
If you want to try using the default pi rpicam apps set use_ard = 0. Complete Arducams install first. Make a copy of /usr/share/libcamera/ipa/rpi/pisp/arducam_64mp.json, edit "rpi.af" to "rpi.mf" and save as /usr/share/libcamera/ipa/rpi/pisp/arducam_64mf.json
