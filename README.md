...
To work with RaspiOS based on BULLSEYE / BOOKWORM, using rpicam / libcamera (NOT raspistill/raspivid). TRIXIE tested with pi update https://forums.raspberrypi.com/viewtopic.php?t=389477
