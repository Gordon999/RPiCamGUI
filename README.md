...
Note if using the hardware from here https://github.com/JennyList/7-inch-touchscreen-camera then try RPiCamera.py, or the Pi 7" mk1 touchscreen, which gives an easier interface.
